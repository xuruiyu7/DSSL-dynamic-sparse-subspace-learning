...
#%%
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_11.mat', {'data_patch': data_patch})
    sio.savemat('data_patch_clean_1.mat', {'data_patch_clean': data_patch_clean})
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_12.mat', {'data_patch': data_patch})
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_13.mat', {'data_patch': data_patch})
    '''
...
#%%
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_21.mat', {'data_patch': data_patch})
    sio.savemat('data_patch_clean_2.mat', {'data_patch_clean': data_patch_clean})
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_22.mat', {'data_patch': data_patch})
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_23.mat', {'data_patch': data_patch})
    '''
#%%
    ### experiments:3
    ### signals:40 subspaces:2 length:128
    ...
    for sigma2 in sigma2_list:
        ...
        for j in range(num_data):
            ...
            data_noise=data*sigma2
            data_past[j,:,:]=data_noise
            
        cp_list=[0,32,64,128]
        K=0
        lambda1,lambda2=determine_parameters(data_past,n_signals,cp_list,K) 
        #lambda1=0.0112*sigma2**2
        #lambda2=170*sigma2**2
...
#%%
    ...
    for i in range(n_experiments):
        ...
        data_patch[i,:,:]=data_noise
        data_patch_clean[i,:,:]=data
    sio.savemat('data_patch_31.mat', {'data_patch': data_patch})
    '''    
